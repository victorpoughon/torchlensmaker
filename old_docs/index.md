...
<em class="hl-green">very experimental</em>
...
<em class="hl-aqua">differentiable geometric optics:</em>
3D collision detection and the laws of optics implemented in
[PyTorch](https://pytorch.org/). PyTorch provides world-class automatic
differentiation, and access to
