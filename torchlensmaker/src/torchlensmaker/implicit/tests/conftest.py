...
from torchlensmaker.implicit.implicit_disk import (
    implicit_disk_2d,
    implicit_disk_3d,
)
...
cases_2d = [
    ...
    pytest.param(partial(implicit_disk_2d, R=1.5), _make_2d_avoid_disk_boundary, id="disk"),
...
cases_3d = [
    ...
    pytest.param(partial(implicit_disk_3d, R=1.5), _make_3d_avoid_disk_boundary, id="disk"),
