...
optics = tlm.Sequential(
    tlm.SubChain(
        ...
        tlm.ObjectAtInfinity(20, angular_size=30, wavelength=(400, 600)),
    ),
    tlm.Gap(20),
...
optics.set_sampling2d(pupil=5, field=3, wavelength=3)
optics.set_sampling3d(pupil=5, field=3, wavelength=3)
